...
UserSchema.virtual('thumbnail').get(function () {
    var default_image = "https://cdn.knightspear.com/images/icons/general/unassigned_v1.0.jpg";
    if(this.picture && this.picture[0] == '/'){
        
        return "/file" + this.picture.substr(0, this.picture.lastIndexOf('.')) + "_small" + this.picture.substr((this.picture.lastIndexOf('.'))).toLowerCase();
